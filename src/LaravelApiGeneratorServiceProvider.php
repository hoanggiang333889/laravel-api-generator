...
use Giangmv\LaravelApiGenerator\Commands\GenerateApi;
...
class LaravelApiGeneratorServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app['router']->middleware('ApiHeaderInject', 'Giangmv\LaravelApiGenerator\Middleware\ApiHeaderInject');

        $this->app['router']->aliasMiddleware('ApiHeaderInject', \Giangmv\LaravelApiGenerator\Middleware\ApiHeaderInject::class);
        $this->app['router']->pushMiddlewareToGroup('api', \Giangmv\LaravelApiGenerator\Middleware\ApiHeaderInject::class);
    }
}
